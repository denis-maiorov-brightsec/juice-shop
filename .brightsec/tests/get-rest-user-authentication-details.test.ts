...
test('GET /rest/user/authentication-details', { signal: AbortSignal.timeout(timeout) }, async () => {
  await runner
    ...
    .run({
      ...
      headers: {
        Authorization:
          'Bearer eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9.eyJkYXRhIjp7ImlkIjoxLCJlbWFpbCI6ImFkbWluQGp1aWNlLXNoLm9wIiwicm9sZSI6ImFkbWluIn0sImlhdCI6MTcxNjIwMDAwMCwiZXhwIjoxNzE2MjIxNjAwfQ.signature'
      },
